  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-5xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-primary flex items-center justify-center shadow-[0_2px_8px_hsl(var(--primary)/0.3)]">
          ...
          <button
            ...
            className="bg-primary text-primary-foreground font-display font-bold text-sm px-5 py-2.5 rounded-xl press-effect hover:shadow-lg hover:shadow-primary/25 transition-all duration-300"
          >
            Start Learning
          </button>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-5xl md:text-7xl font-bold text-foreground leading-[1.05] mb-5 animate-slide-up" style={{ animationDelay: '100ms' }}>
              Make Science
              <br />
              <span className="bg-gradient-to-r from-primary via-combo to-xp bg-clip-text text-transparent">
                Your Superpower
              </span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3 animate-slide-up" style={{ animationDelay: '300ms' }}>
              <button
                onClick={() => navigate('/home')}
                className="bg-primary text-primary-foreground font-display font-bold text-base px-8 py-4 rounded-2xl press-effect hover:shadow-xl hover:shadow-primary/25 transition-all duration-300 flex items-center gap-2"
              >
                <Zap className="w-5 h-5" /> Play Now
              </button>
              <a
                href="#features"
                className="bg-card text-foreground border border-border font-display font-bold text-base px-8 py-4 rounded-2xl press-effect hover:shadow-lg transition-all duration-300"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="grid grid-cols-4 gap-4 mt-16 animate-slide-up" style={{ animationDelay: '400ms' }}>
            {stats.map(s => (
              <div key={s.label} className="text-center bg-card/50 rounded-2xl p-4 border border-border/30">
                <p className="font-display font-bold text-3xl md:text-4xl text-foreground bg-gradient-to-r from-primary to-xp bg-clip-text text-transparent">{s.value}</p>
      ...
      <section id="features" className="py-20 px-5 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-primary/3 via-transparent to-xp/3 pointer-events-none" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <RevealSection key={f.title} delay={i * 70}>
                <div className="bg-card rounded-2xl p-6 border border-border hover:shadow-lg hover:border-border/80 transition-all duration-300 h-full group">
            ...
            {[
              ...
              <RevealSection key={item.step} delay={i * 100}>
                <div className="relative">
                  <span className="font-display text-7xl font-bold text-primary/8 absolute -top-8 -left-2">{item.step}</span>
      ...
      <section className="py-20 px-5">
        <RevealSection>
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-primary via-[hsl(280,87%,50%)] to-combo rounded-3xl p-10 md:p-16 text-center relative overflow-hidden">

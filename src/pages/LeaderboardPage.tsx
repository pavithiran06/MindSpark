  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-xp/10 to-transparent" />
      ...
      <div className="px-5 mb-5 animate-slide-up" style={{ animationDelay: '60ms' }}>
        <div className="glass rounded-2xl p-4 border-primary/20 shadow-[0_2px_12px_hsl(var(--primary)/0.1)] flex items-center gap-3">
          ...
          {[1, 0, 2].map((podiumIdx, visualIdx) => {
            ...
            return (
              <div key={entry.rank} className="flex flex-col items-center">
                <div className={`${containerSize} rounded-2xl glass ${
      ...
      <div className="px-5 space-y-2 stagger-children">
        {leaderboardData.slice(3).map(entry => (
          <div
            key={entry.rank}
            className="flex items-center gap-3 p-3.5 rounded-2xl glass hover:shadow-[0_2px_8px_hsl(var(--primary)/0.08)] transition-shadow"
          >
